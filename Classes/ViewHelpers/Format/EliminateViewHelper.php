...
class EliminateViewHelper extends AbstractViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('trimWhitespace', 'boolean', 'String to trim', false, false);
    }
    ...
    public static function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        if (true === $arguments['trimWhitespace']) {
            $content = static::eliminateTrim($content, (boolean) $arguments['caseSensitive']);
        }
        return $content;
    }
     ...
     * @return string
     */
    protected static function eliminateTrim($content, $caseSensitive)
    {
        $caseSensitiveIndicator = true === $caseSensitive ? 'i' : '';
        $content = preg_replace('/\s{2,}/i' . $caseSensitiveIndicator, '', $content);
